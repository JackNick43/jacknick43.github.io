<!DOCTYPE html>
<!-- saved from url=(0037)http://127.0.0.1:5500/login/index.php -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script async="" data-id="five-server" data-file="${filePath}" type="application/javascript" src="./404_files/fiveserver.js.download"></script>

    <link rel="stylesheet" href="./404_files/directory.css">
  <style>      
  ...
  <body>
    ...
    <div id="wrapper">
      <div class="directory">
        <h1><a href="http://127.0.0.1:5500/">~</a> / <a href="http://127.0.0.1:5500/login">login</a> / <a href="http://127.0.0.1:5500/login/index.php">index.php</a></h1>
